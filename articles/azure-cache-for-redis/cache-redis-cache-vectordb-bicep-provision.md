---
title: Deploy Azure Cache for Redis as Vector DB using Bicep
description: Learn how to use Bicep to deploy an Azure Cache for Redis Vector DB resource.
author: manjitsin
ms.author: manjitsin 
ms.service: cache
ms.topic: conceptual
...
# Quickstart: Create an Azure Cache for Redis as Vector DB using Bicep
